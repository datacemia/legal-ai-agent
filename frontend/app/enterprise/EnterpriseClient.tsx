 ...
 en: {
    ...
    education: {
      ...
      whyItems: [
        ...
        "No personal data used to train public AI models",
  ...
  fr: {
    ...
    education: {
      ...
      whyItems: [
        ...
        "Aucune donnée personnelle utilisée pour entraîner des modèles IA publics",
   ...
   heroTitle: "Runexa للشركات",
    ...
    education: {
      ...
      whyItems: [
        ...
        "لا تُستخدم أي بيانات شخصية لتدريب نماذج الذكاء الاصطناعي العامة",
