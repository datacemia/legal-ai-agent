...
const labels: any = {
  en: {
    ...
    whatYouGet: "Analysis results",
    whatYouGetItems: [
      "Identify important contract clauses",
      "Summarize financial and legal obligations",
      "Explain practical risks in plain language",
      "Suggest points that may be negotiated",
    ],
    howItWorks: "How to use it",
    howItWorksItems: [
      "Upload the contract file",
      "Choose the analysis language",
      "Click Analyze Contract",
      "Receive a structured report in seconds",
    ],
    summary: "Summary",
  ...
  fr: {
    ...
    whatYouGet: "Résultat de l’analyse",
    whatYouGetItems: [
      "Identification des clauses importantes",
      "Résumé des obligations financières et juridiques",
      "Explication des risques pratiques en langage clair",
      "Suggestions de points à négocier",
    ],
    howItWorks: "Mode d’utilisation",
    howItWorksItems: [
      "Importez le fichier du contrat",
      "Choisissez la langue d’analyse",
      "Cliquez sur Analyser le contrat",
      "Recevez un rapport structuré en quelques secondes",
    ],
    summary: "Résumé",
  ...
  ar: {
    ...
    whatYouGet: "نتائج التحليل",
    whatYouGetItems: [
      "تحديد البنود المهمة في العقد",
      "تلخيص الالتزامات المالية والقانونية",
      "شرح المخاطر العملية بلغة واضحة",
      "اقتراح نقاط يمكن التفاوض عليها",
    ],
    howItWorks: "طريقة الاستخدام",
    howItWorksItems: [
      "ارفع ملف العقد",
      "اختر لغة التحليل",
      "اضغط على زر تحليل العقد",
      "استلم تقريراً منظماً خلال ثوانٍ",
    ],
    summary: "الملخص",
