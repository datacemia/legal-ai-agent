...
export default function HomeClient({
  ...
  const localePrefix =
    language === "fr" ? "/fr" : language === "ar" ? "/ar" : "";

  const demoHref = (slug: string) => `${localePrefix}/demo/${slug}`;
            ...
            <div className="relative grid items-center gap-10 lg:grid-cols-[1.05fr_0.95fr]">
              <div className="space-y-7">
                ...
                <div className="grid max-w-2xl gap-3">
                  <Link
                    href="/pricing"
                    className="group rounded-3xl border border-blue-200 bg-gradient-to-r from-blue-600 to-indigo-600 p-5 text-white shadow-xl shadow-blue-200 transition hover:-translate-y-0.5 hover:shadow-blue-300"
                  >
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        <p className="text-lg font-black">
                          {language === "fr"
                            ? "Essayez Runexa pour 1 $"
                            : language === "ar"
                            ? "جرّب Runexa مقابل دولار واحد"
                            : "Try Runexa for $1"}
                        </p>
                        <p className="mt-1 text-sm font-semibold text-blue-100">
                          {language === "fr"
                            ? "Analysez un document réel en quelques minutes."
                            : language === "ar"
                            ? "وحلل مستنداً حقيقياً خلال دقائق."
                            : "Analyze a real document in minutes."}
                        </p>
                      </div>
                  ...
                  <div className="rounded-2xl border border-blue-100 bg-white/85 px-5 py-4 text-sm font-semibold text-slate-700 shadow-sm">
                    <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                      <span>
                        {language === "fr"
                          ? "Point d'entrée le plus utilisé : Runexa Legal Agent"
                          : language === "ar"
                          ? "الأكثر استخداماً للبدء: Runexa Legal Agent"
                          : "Most Popular Starting Point: Runexa Legal Agent"}
                      </span>
                      <span className="text-blue-700">{t.trustLine}</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="relative grid gap-8 p-6 md:grid-cols-2 md:p-10">
              <div className="space-y-5">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="relative rounded-2xl border-2 border-blue-200 bg-blue-50 p-5 shadow-sm">
                ...
                <div className="rounded-3xl border border-blue-100 bg-white p-5 shadow-sm">
                  <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                    <div>
                      <p className="text-sm font-semibold text-blue-600">
                        {language === "fr"
                          ? "Voir des démonstrations réelles"
                          : language === "ar"
                          ? "شاهد عروضاً توضيحية حقيقية"
                          : "View Real Demo Reports"}
                      </p>
                      <p className="mt-1 text-sm leading-6 text-slate-600">
                        {language === "fr"
                          ? "Explorez les exemples publics de rapports Runexa pour chaque agent."
                          : language === "ar"
                          ? "استكشف أمثلة عامة لتقارير Runexa لكل وكيل."
                          : "Explore public Runexa report examples for each agent."}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="mt-4 grid gap-3 sm:grid-cols-2">
                    {[
                      ...
                      },
                      {
                        ...
                        label:
                          language === "fr"
                            ...
                            ? "عرض وكيل الدراسة"
                            : "Study Agent Demo",
                        style: "border-violet-100 bg-violet-50 text-violet-700",
                      },
                      {
                        href: demoHref("business-agent"),
                        label:
                          language === "fr"
                            ? "Démo Business Agent"
                            : language === "ar"
                      ...
                      <Link
                        key={demo.href}
                        href={demo.href}
                        className={`inline-flex items-center justify-between rounded-2xl border px-4 py-3 text-sm font-bold transition hover:-translate-y-0.5 ${demo.style}`}
                      >
