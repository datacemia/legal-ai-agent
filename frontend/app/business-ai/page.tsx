...
const translations = {
  ...
  fr: {
    ...
    jsonDescription:
      "Utilisez Runexa Business Agent pour analyser KPI, risques business, opportunités, prévisions et insights exécutifs avec une business intelligence alimentée par l’IA.",
  },
  ...
  ar: {
    ...
    jsonDescription:
      "استخدم Runexa Business Agent لتحليل مؤشرات الأداء ومخاطر الأعمال والفرص والتوقعات والرؤى التنفيذية باستخدام ذكاء الأعمال المدعوم بالذكاء الاصطناعي.",
  },
};
