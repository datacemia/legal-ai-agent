  ...
  return (
    <main className="min-h-screen bg-slate-50 px-6 py-20 text-slate-900">
      ...
      <section className="mx-auto mt-16 grid max-w-6xl gap-6 md:grid-cols-4">
        {[
          ["AI summaries", "Generate structured summaries from study materials and documents."],
          ["Flashcards & quizzes", "Create interactive learning material automatically with AI."],
          ["Study plans", "Organize revision sessions and learning goals more efficiently."],
          ["Learning workflows", "Build faster and more structured study workflows with AI assistance."],
        ].map(([title, desc]) => (
