      ...
      <div className="max-w-3xl mx-auto bg-white p-8 rounded-3xl border shadow-sm space-y-8">
        ...
        <section>
          ...
          <ul className="mt-4 list-disc pl-5 text-slate-600 space-y-2">
            <li>{t.acceptableUseProhibited1 || "Illegal, fraudulent, or deceptive activity"}</li>
            <li>{t.acceptableUseProhibited2 || "Malware, phishing, hacking, unauthorized access, or cyber abuse"}</li>
            <li>{t.acceptableUseProhibited3 || "Harassment, threats, abuse, discrimination, or harmful conduct"}</li>
            <li>{t.acceptableUseProhibited4 || "Uploading or processing content that violates intellectual property, privacy, confidentiality, or contractual rights"}</li>
            <li>{t.acceptableUseProhibited5 || "Impersonation, identity fraud, or misleading representations"}</li>
            <li>{t.acceptableUseProhibited6 || "Unauthorized surveillance, monitoring, or tracking of individuals"}</li>
            <li>{t.acceptableUseProhibited7 || "Generating harmful, dangerous, or unlawful content"}</li>
            <li>{t.acceptableUseProhibited8 || "Attempting to reverse engineer, disrupt, overload, or bypass the platform or security protections"}</li>
            <li>{t.acceptableUseProhibited9 || "Using automated systems to abuse, scrape, spam, or excessively overload the services"}</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p className="mt-2 text-slate-600">contact@runexa.ai</p>
        </section>
