...
const API_URL = process.env.NEXT_PUBLIC_API_URL || "https://api.runexa.ai";
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="text-gray-500 mt-1">
              Manage users, roles, credits, waitlists, free access requests,
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <a
              href="/admin/free-access-requests"
