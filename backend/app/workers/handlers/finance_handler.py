...
def handle_finance_ai(job: Job, db):
    ...
    print("OBSERVED INCOME =", forecast.get("observed_income"))
    print("OBSERVED EXPENSES =", forecast.get("observed_expenses"))
    print("NET CASHFLOW =", forecast.get("observed_net_cashflow"))
