...
BUSINESS_MODELS = {
    ...
    "finance": [
        # Industry-specific finance signals only.
        # Generic KPI/accounting words such as revenue, cashflow, budget,
        # forecast, invoice, and payment are intentionally excluded because
        # they exist across nearly every industry and should not classify a
        # generic business performance file as Finance.
        "finance", "financial", "accounting", "ledger",
        "balance", "asset", "liability", "equity",
        "bank", "loan", "interest_income", "fee_income", "commission_income",
        "portfolio", "deposit", "credit", "debt", "aum", "assets_under_management",
        "finance", "financier", "comptabilite", "comptabilité",
        "grand_livre", "solde", "actif", "passif", "capitaux_propres",
        "banque", "pret", "prêt", "revenu_financier", "produits_financiers",
        "interets", "intérêts", "revenus_interets", "revenus_intérêts",
        "portefeuille", "depot", "dépôt", "credit", "crédit", "dette",
        "مالية", "تمويل", "محاسبة", "دفتر_الأستاذ",
        "رصيد", "أصل", "أصول", "التزام", "التزامات", "حقوق_ملكية",
        "بنك", "قرض", "إيرادات_مالية", "دخل_الفوائد", "عمولات",
        "محفظة", "وديعة", "ائتمان", "دين",
