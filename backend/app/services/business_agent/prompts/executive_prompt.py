...
- If the file is a product catalog, inventory list, SKU list, price list, reference table, or non-performance dataset, do not invent financial KPIs.
...
- Never display None/100, null/100, N/A/100, Unknown/100, or 0/100 as a valid Business Health Score.
- If Business Health Score is unavailable, explain that it could not be calculated due to insufficient business performance data.
- Do not treat missing revenue, expenses, profit, cashflow, churn, ROAS, CAC, or customers as zero unless the file explicitly proves the value is zero.
- Use only verified business metrics in user-facing explanations.
